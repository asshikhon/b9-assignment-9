...
import imgLogin from "../../../src/assets/images/login.jpg";
...
toast.error(error.message);
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
        `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${imgLogin})`,
    ...
    >
      ...
      <div className="w-full max-w-md p-8 space-y-3 rounded-xl  bg-gray-900 text-gray-100">
        <h1 className="text-2xl font-bold text-center animate__animated animate__bounceInDown">
          Login
        </h1>
        <form
          onSubmit={handleLogin}
          className="space-y-6 animate__animated animate__zoomInUp"
        >
        ...
        <div className="flex justify-center space-x-4 animate__animated  animate__fadeInBottomRight">
        ...
        <p className="text-xs animate__animated animate__fadeInBottomLeft text-center sm:px-6 text-gray-400">
          Do not have an account?
          <Link
            to="/register"
            rel="noopener noreferrer"
            href="#"
            className="underline pl-1 text-gray-100"
          >
            Register now
          </Link>
        </p>
