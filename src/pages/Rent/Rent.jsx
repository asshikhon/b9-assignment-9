...
import logoRent from "../../../src/assets/images/rent.png"
...
const Rent = () => {
    ...
    useEffect(() => {
      fetch('/card.json')
        ...
        .then(data => {
          const rentData = data.filter(property => property.status === 'rent');
...
<Helmet>
<link rel="icon" type="image/svg+xml" href={logoRent} />
<title>HomeHaven || Rent</title>
</Helmet>
